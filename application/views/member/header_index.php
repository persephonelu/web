            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        <li id="index">
                        <a href="<?php echo base_url()?>user_app?nav=index">
                        <i class="fa fa-dashboard fa-fw"></i>我的app</a>
                        </li>
                         <li id="add_app">
                         <a href="<?php echo base_url()?>user_app/add_app?nav=add_app">
                    <i class="fa fa-plus-square fa-fw"></i>添加app</a>
                        </li>
                    </ul>
                </div>
                <!-- /.sidebar-collapse -->
